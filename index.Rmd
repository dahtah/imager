...
or [click here](https://cran.r-project.org/web/packages/imager/vignettes/gettingstarted.html).
...
The next step is to learn about [pixsets](https://cran.r-project.org/web/packages/imager/vignettes/pixsets.html), which are used to represent sets of pixels (e.g., the foreground in an image).

		vignette("pixsets",package="imager")

The [vignette](https://cran.r-project.org/web/packages/imager/vignettes/pixsets.html) includes an example of image segmentation. 
...
<div class = "col-sm-6 col-md-3">
	...
	<img src="gallery/unshuffle.gif"  />
        <h3><a href="unshuffle.html">Image unshredding</a></h3>
...
<div class = "col-sm-6 col-md-3">
	    <div class="thumbnail">
		<img src="gallery/cpp.png" width="300px" />
        <h3><a href="cpp_api.html">Using the C++ api</a></h3>
      <p> For better performance you can call CImg directly </p>
    </div>
...
<div class = "col-sm-6 col-md-3">
	    <div class="thumbnail">
		<img src="gallery/ascii_art.png" width="300px" />
        <h3><a href="ascii_art.html">ASCII art</a></h3>
      <p> How to render an image using only characters </p>
    </div>
