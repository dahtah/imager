...
There's a [tutorial](image_stats.html) on natural image statistics using imager as well as classical package [documentation](imager.html). In addition functions are documented using R's traditional help system, and you might find [CImg](http://cimg.sourceforge.net/)'s doc useful as well. 
