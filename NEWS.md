# imager 0.40 Major release
   ...
   * improved reductions (parmax, parmin, etc.). Most are now implemented in C++ and run in parallel using OpenMP. A median combine operation (parmedian) has been added, thanks to a suggestion by Aaron Robotham. 
