...
args <- ' -I/usr/share/R/include -DNDEBUG -Dcimg_use_openmp -fopenmp  -Dcimg_use_fftw3   -I../inst/include -DCIMG_COMPILING -Dcimg_use_rng -Dcimg_r_mode -Dcimg_use_fftw3_singlethread -Dcimg_verbosity=1   -I"/home/simon/R/x86_64-pc-linux-gnu-library/3.3/Rcpp/include"   -fpic  -O2 -fstack-protector --param=ssp-buffer-size=4 -Wformat -Werror=format-security -D_FORTIFY_SOURCE=2  -c %s.cpp -o %s.o'
